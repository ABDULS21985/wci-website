...
const benefits = [
    ...
    },
    {
        icon: FileSearch,
        title: "Audit Ready",
        description: "Documentation prepared",
    },
    {
        icon: Shield,
        title: "Risk Managed",
        description: "Proactive controls",
    },
];

export function GovernanceSection() {
    const category = getServiceCategoryById("it-governance");
    ...
    return (
        ...
        >
            <div className="container mx-auto px-4 md:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                        ...
                        <div className="flex flex-wrap lg:flex-nowrap gap-4">
                            {benefits.map((benefit, index) => (
                                <div
                                    key={index}
                                    className="flex items-center gap-3 px-4 py-3 bg-gradient-to-br from-primary/5 to-secondary/5 rounded-xl border border-primary/10 animate-fade-in-up"
                ...
                {/* Frameworks Section */}
                <div
                    className="p-6 md:p-8 bg-gradient-to-br from-primary/5 to-secondary/5 rounded-2xl border border-primary/10 animate-fade-in-up"
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-3">
                                {frameworks.map((framework, index) => (
                                    <span
                                        key={index}
                                        className="px-4 py-2 bg-white border border-primary/20 rounded-full text-sm font-medium"
                                        style={{ color: ACCENT_COLOR }}
                                    >
                                        {framework}
                                    </span>
